	...
	render() {
		...
		return(
			...
			<div className="flipContainer">
				<center className="title">Expired</center>
			</div>
			:
			<div className="flipContainer">
				<center className="title">{this.state.titleText}</center>
				<div className="flipClock">	
					{
						...
						<div className="flipCover">
							<FlipUnitContainer 
								...
								shuffle={daysShuffle} 
							/>
							<center className="font8">DAY</center>
						</div>
					}
					<div className="flipCover">	
						<FlipUnitContainer 
						...
						/>
						<center className="font8">HRS</center>
					</div>
					<div className="flipCover">
						<FlipUnitContainer 
							unit={'minutes'}
						...
						/>
						<center className="font8">MIN</center>
					</div>
					<div className="flipCover">
						<FlipUnitContainer 
							unit={'seconds'}
						...
						/>
						<center className="font8">SEC</center>
					</div>
				</div>
			</div>
		);
